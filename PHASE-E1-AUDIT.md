...
| E1.5 | CampaignForm "set once, override rarely" | ✅ DONE (already met) | `app/components/CampaignForm.tsx` inherits store defaults; Payment defaults collapse behind a **"Customize payment"** `Collapsible`, and Discount / Copy / Internal-notes collapse behind a **"Show advanced"** toggle ("Store-wide options live in Settings"). All 28 fields retained — verified no schema/field removed. |
