...
## THE FEATURE RULE (added 2026-08-31 — Kanwar's standing directive)

No NEW feature may be implemented without Kanwar's explicit approval, requested FIRST as simple bullets:
- **Why this feature** — the problem/opportunity, one line.
...
Wait for his yes before writing any code. Fixes to existing promised behavior (bugs, dead paths, polish) are not new features. Plan of record: `ENCORE-10X-PLAN.md`.
