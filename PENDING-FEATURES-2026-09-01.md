...
| 4 | **`ENCORE_EMAIL_API_KEY` + verified `ENCORE_EMAIL_FROM`** on Railway | Kanwar | Back-in-stock alerts, ship-date changes, balance reminders all queue silently without it |
