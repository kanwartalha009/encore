...
| **Routes / nav parity** | ✅ PASS | All 12 nav `s-link`s resolve to real routes (`/app`, campaigns, cohorts, demand, markets, benchmark, waitlist, low-stock, translations, notifications, settings, plans). *(E1 collapses this 12 → 6.)* |
